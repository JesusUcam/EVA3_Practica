...
public class Principal {
	...
	public static void main(String[] args) {
		...
		while (!key) {
			...
			case 2:
				...
				Producto.comprarProducto(Cliente.iniciarSesion());
	
				break;
			case 3:
				
				Cliente.mostrarCesta(Cliente.iniciarSesion()); //Tengo que arreglarlo, no se como agregar productos a cestas concreta.
	
				break;
			case 4:
				
				//Requiere el 3 porque las cestas todavia no estan bien hechas
	...
	public static void insertarDatos() {
		...
		Boligrafo boligrafo1 = new Boligrafo("1", "BicAzul", "un clasico de los boligrafos azules", 0.22, 4, 0.5, "azul");
		...
		Carpeta carpeta1 = new Carpeta("4", "Carpeta Verde", "Carpeta grande low cost", 3, 7, false);
		...
		Estuche estuche2 = new Estuche("6", "Estuche pro", "Estuche de alta calidad para profesionales", 89.99, 3, "pro", 5);
